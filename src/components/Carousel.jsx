...
const Carousel = () => {
  ...
  // ✅ Ensure only one product per category (max 15 categories)
  const uniqueCategoryItems = useMemo(() => {
    if (!data) return [];
            ...
            <div className="flex flex-col md:flex-row gap-10 justify-center h-[600px] my-20 md:my-0 items-center px-4">
              <div className="md:space-y-6 space-y-3">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-red-500 to-purple-500 text-white px-3 py-2 rounded-md cursor-pointer mt-2 hover:shadow-lg transition-all duration-300 transform hover:scale-105"
                >
                  Shop Now
                </button>
              </div>
